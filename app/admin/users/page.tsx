      ...
      <div className="space-y-6">
        ...
        <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6">
          ...
          <p className="text-gray-400">
            Gérez tous les utilisateurs de la communauté TFD
          </p>
        </div>
        ...
        <div className="bg-black/40 backdrop-blur-sm border border-gray-800/50 rounded-xl p-12 text-center">
          ...
          <button className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-lg text-white font-medium hover:from-green-500 hover:to-emerald-500 transition-all duration-300">
